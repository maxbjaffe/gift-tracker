...
export async function GET(
  ...
  try {
    ...
    const html = generatePDFHTML(recipient, giftRecipients || [], origin);
...
function generatePDFHTML(recipient: any, giftRecipients: any[], origin: string): string {
...
<body>
  ...
  <div class="footer">
    ...
    ${recipient.share_enabled && recipient.share_token ? `
      <p>Share this list: ${origin}/share/${recipient.share_token}</p>
    ` : ''}
  </div>
